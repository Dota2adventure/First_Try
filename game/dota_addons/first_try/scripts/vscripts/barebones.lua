...
HERO_SELECTION_TIME = 0.5              -- How long should we let people select their hero?
PRE_GAME_TIME = 0.0                    -- How long after people select their heroes should the horn blow and the game start?
POST_GAME_TIME = 360.0                  -- How long should we let people look at the scoreboard before closing the server automatically?
TREE_REGROW_TIME = 1000000.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
NO_SHOP_OUTSIDE = true 					-- Don't allow shopping outside the range of shops
...
function GameMode:InitGameMode()
	...
	--ListenToGameEvent("dota_glyph_used", Dynamic_Wrap(GameMode, "OnGlyphUsed"), self)
...
function GameMode:CaptureGameMode()
	if mode == nil then
		...
		mode:SetStashPurchasingDisabled( NO_SHOP_OUTSIDE )
